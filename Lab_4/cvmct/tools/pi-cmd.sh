...
# Version: 2
# 
# **** "pi-cmd", remote *sudo* command line tool for one pi of our pi-Farm ***
#
# DO NOT execute as sudo or root.
# 
#
# pi-cmd.sh "command [arguments]" PiNr
#  Executes sudo-bash-commands on one remote pi. 
#  Use remote Commandline with command-arguments in "quotes"
# pi-cmd.sh "ls -al" PiNr
#
# pi-cmd.sh poweroff 22
#  schaltet 22 aus
#
...
if [ $# -ne 2 ] 
then
echo "syntax: pi-cmd.sh \"cmd [arguments]\" PiNr"
exit
fi
